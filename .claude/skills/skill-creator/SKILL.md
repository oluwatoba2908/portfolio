---
name: skill-creator
description: A skill for creating new skills and iteratively improving them. Use this skill whenever the user wants to create, draft, test, evaluate, or iterate on a Claude skill. Trigger when the user says "create a skill", "make a skill", "write a skill", "turn this into a skill", "skill for X", "new skill", "improve this skill", "test this skill", "evaluate this skill", or references SKILL.md authoring, skill packaging, or skill description optimization. Also trigger when the user wants to benchmark or compare skill versions, run eval cases against a skill, or optimize a skill's trigger description.
---
