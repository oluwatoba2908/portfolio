...
(() => {
  ...
  const stylesheet =
    ...
    '  --slot-ink:rgba(0,0,0,.55);--slot-ink-strong:rgba(0,0,0,.75);' +
    '  --slot-line:rgba(0,0,0,.25);--slot-fill:rgba(0,0,0,.04);' +
    '  font:13px/1.3 system-ui,-apple-system,sans-serif;color:var(--slot-ink);' +
    '  width:100%;height:100%;aspect-ratio:3/2}' +
    // theme="dark" retints the placeholder for near-black panels
    ':host([theme="dark"]){--slot-ink:rgba(255,255,255,.62);--slot-ink-strong:rgba(255,255,255,.9);' +
    '  --slot-line:rgba(255,255,255,.28);--slot-fill:rgba(255,255,255,.05);' +
    '  --slot-error-bg:#2a2a2a;--slot-error-ink:rgba(255,255,255,.7)}' +
    '.frame{position:absolute;inset:0;overflow:hidden;background:var(--slot-fill)}' +
    ...
    '.empty .sub u{text-underline-offset:2px;text-decoration-color:var(--slot-line)}' +
    '.empty:hover .sub u{color:var(--slot-ink-strong);text-decoration-color:currentColor}' +
    ':host([data-over]) .frame{outline:2px solid #c96442;outline-offset:-2px;' +
    '  background:rgba(201,100,66,.10)}' +
    '.ring{position:absolute;inset:0;pointer-events:none;border:1.5px dashed var(--slot-line);' +
    ...
    '  justify-content:center;gap:6px;text-align:center;padding:12px;box-sizing:border-box;' +
    '  background:var(--slot-error-bg,#f2f1ef);color:var(--slot-error-ink,#6e6c66);user-select:none;' +
